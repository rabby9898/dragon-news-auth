...
const NewsDetails = () => {
  ...
  return (
    <div className="px-5 md:px-10 lg:px-32">
      <Header></Header>
      <Navbar></Navbar>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-8 lg:gap-20 my-10">
        <div className="col-span-1 lg:col-span-2 p-3 lg:p-10 border border-gray-200 rounded-lg w-full h-max">
